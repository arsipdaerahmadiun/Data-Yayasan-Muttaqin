...
.dark.bg-slate-950, .dark .bg-slate-950, .dark.bg-slate-100, .dark .bg-slate-100\/70, .dark .bg-slate-50\/70 {
  background-color: #121417 !important;
}

/* Ensure the <main> tag specifically gets the dark background */
.dark main {
  background-color: #121417 !important;
}
